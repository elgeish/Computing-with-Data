...
Of course there are many improvements we can make here to reduce contention;
for example, following the best practice of reducing the time a thread spends
